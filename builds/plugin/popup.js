/******/ ;(() => {
  ...
  \****************************************/
      /***/ (
        ...
        /* harmony import */ var _subroutines_scraper__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(
            /*! ../subroutines/scraper */ './src/subroutines/scraper.js'
          )
        /* harmony import */ var _subroutines_math__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(
        ...
        function ListingData(props) {
          ...
          ;(0, preact_hooks__WEBPACK_IMPORTED_MODULE_1__.useEffect)(
            function () {
              ...
              ;(0,
              _subroutines_scraper__WEBPACK_IMPORTED_MODULE_2__.runScraper)(
                function (res) {
                  if (!res) {
                    setErrorMessage(
                  ...
                  setPriceEstimate(
                    (0, _subroutines_math__WEBPACK_IMPORTED_MODULE_3__.toInt)(
                      results.estimatePrice
                    )
                  )
                  ...
                  var usedAlready = configurationFields.uses.filter(function (
                    d
                  ) {
          ...
          var _calculateCOC = (0,
            _subroutines_math__WEBPACK_IMPORTED_MODULE_3__.calculateCOC)(
              configurationFields,
              price,
              taxes,
              rentEstimate
          ...
          var getDataFields = function getDataFields() {
            return {
              purchasePrice: (0,
              _subroutines_utils__WEBPACK_IMPORTED_MODULE_4__.dollars)(price),
              monthlyTaxes: (0,
              _subroutines_utils__WEBPACK_IMPORTED_MODULE_4__.monthlyDollars)(
                taxes
              ),
              monthlyRent: (0,
              _subroutines_utils__WEBPACK_IMPORTED_MODULE_4__.monthlyDollars)(
              ...
              address: address,
              estimatePrice: (0,
              _subroutines_utils__WEBPACK_IMPORTED_MODULE_4__.dollars)(
                priceEstimate
              ),
              bedsBath: specs,
          ...
          var handleCopyClick = function handleCopyClick() {
            ...
            ;(0, _subroutines_utils__WEBPACK_IMPORTED_MODULE_4__.handleCopy)(
              getDataFields(),
              tabSeparator
            )
          }

          var redfinLink = 'https://www.google.com/search?q='.concat(
            encodeURIComponent(address + ' redfin')
          )
          var realtorLink = 'https://www.google.com/search?q='.concat(
            encodeURIComponent(address + ' realtor')
          )
          var cocErrorState = !cashOnCash
            ? ''
            : cashOnCash > 0
            ? 'success'
            : 'error'
          ...
          var details = (0, preact__WEBPACK_IMPORTED_MODULE_0__.h)(
            ...
            (0, preact__WEBPACK_IMPORTED_MODULE_0__.h)(
              ...
              (0, preact__WEBPACK_IMPORTED_MODULE_0__.h)(
                ...
                {
                  class:
                    'flex between centered-items personal-space-small-bottom',
                },
                (0, preact__WEBPACK_IMPORTED_MODULE_0__.h)(
                  'label',
                  {
            ...
            (0, preact__WEBPACK_IMPORTED_MODULE_0__.h)(
              ...
              (0, preact__WEBPACK_IMPORTED_MODULE_0__.h)(
                ...
                {
                  className:
                    'flex centered-items between personal-space-bottom personal-space-top',
                },
                (0, preact__WEBPACK_IMPORTED_MODULE_0__.h)(
                  'label',
                  {
          ...
          var jwtHash = configurationFields.jwt
            ? Object.keys(configurationFields.jwt)
                .map(function (key) {
                  return ''
                    .concat(key, '=')
                    .concat(configurationFields.jwt[key])
                })
                .join('&')
            : ''
          var content
          ...
          if (!user) {
            content = (0, preact__WEBPACK_IMPORTED_MODULE_0__.h)(
              'p',
              null,
            ...
            content = (0, preact__WEBPACK_IMPORTED_MODULE_0__.h)(
              ...
              (0, preact__WEBPACK_IMPORTED_MODULE_0__.h)(
                'p',
                null,
                'You are out of free uses. The free plan only allows for ',
                freeUses,
                ' ',
                'free uses a month'
              ),
        ...
        function PluginLoginButton(props) {
          ...
          return (0, preact__WEBPACK_IMPORTED_MODULE_0__.h)(
            ...
            (0, preact__WEBPACK_IMPORTED_MODULE_0__.h)(
              'p',
              null,
              'To use the plugin, you must log in or create a new account.'
            ),
            (0, preact__WEBPACK_IMPORTED_MODULE_0__.h)(
              'div',
              {
  ...
  \**********************************/
    ...
    /* harmony import */ var _api_user__WEBPACK_IMPORTED_MODULE_4__ =
      __webpack_require__(/*! ../api/user */ './src/api/user.js')
    /* harmony import */ var _components_ListingData__WEBPACK_IMPORTED_MODULE_5__ =
      __webpack_require__(
        /*! ../components/ListingData */ './src/components/ListingData.jsx'
      )
    /* harmony import */ var _components_Signup__WEBPACK_IMPORTED_MODULE_6__ =
      __webpack_require__(
    ...
    /* harmony import */ var _components_ForgotPassword__WEBPACK_IMPORTED_MODULE_9__ =
      __webpack_require__(
        /*! ../components/ForgotPassword */ './src/components/ForgotPassword.jsx'
      )
    /* harmony import */ var _components_ConfirmForgotPassword__WEBPACK_IMPORTED_MODULE_10__ =
      __webpack_require__(
        /*! ../components/ConfirmForgotPassword */ './src/components/ConfirmForgotPassword.jsx'
      )
    /* harmony import */ var _components_PluginLoginButton__WEBPACK_IMPORTED_MODULE_11__ =
      __webpack_require__(
        /*! ../components/PluginLoginButton */ './src/components/PluginLoginButton.jsx'
      )
    function _slicedToArray(arr, i) {
      return (
        _arrayWithHoles(arr) ||
    ...
    function Popup(props) {
      ...
      ;(0, preact_hooks__WEBPACK_IMPORTED_MODULE_1__.useEffect)(
        function () {
          ...
          axios__WEBPACK_IMPORTED_MODULE_2___default().defaults.headers.common.Authorization =
            'Bearer '.concat(jwt.id_token)
          ;(0, _api_user__WEBPACK_IMPORTED_MODULE_4__.getUserData)(
            backendUrl,
            function (data) {
              setUser(data)
            },
      ...
      if (configurationFields.jwt) {
        return (0, preact__WEBPACK_IMPORTED_MODULE_0__.h)(
          _components_ListingData__WEBPACK_IMPORTED_MODULE_5__['default'],
          {
            configurationFields: configurationFields,
        ...
        return (0, preact__WEBPACK_IMPORTED_MODULE_0__.h)(
          _components_PluginLoginButton__WEBPACK_IMPORTED_MODULE_11__[
            'default'
          ],
          {
            webappUrl: webappUrl,
    ...
    ;(0, _build_entry__WEBPACK_IMPORTED_MODULE_3__['default'])(
      (0, preact__WEBPACK_IMPORTED_MODULE_0__.h)(Popup, null)
    )
  })()
