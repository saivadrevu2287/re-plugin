...
// const InitialTotalInvestment = (purchasePrice) =>
...
//     MonthlyExpenses(taxes, monthlyGrossIncome) +
...
const doCOC = (purchasePrice, monthlyTaxes, monthlyRent) => {
  ...
  if (purchasePrice && monthlyTaxes && monthlyRent) {
    const { cashOnCash, monthlyExpenses } = calculateCOC(
      purchasePrice,
      monthlyTaxes,
      monthlyRent
    )
